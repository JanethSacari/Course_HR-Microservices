...
class HrUserApplicationTest {
    ...
    @Test
    void main() {
        assertDoesNotThrow(() -> HrUserApplication.main(new String[]{}));
    }

    @Test
    void run() {
        assertNotNull(HrUserApplication.class.getAnnotation(SpringBootApplication.class),
                "SpringBootApplication annotation should be present");
        assertNotNull(HrUserApplication.class.getAnnotation(EnableEurekaClient.class),
